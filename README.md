...
### Секс-ходи навичок
У активній секс-сцені з’являється смуга **«Ходи навичок»** (зв’язок із деревом у сайдбарі).  
`POST /api/sex-turn` рахує pleasure/stamina/phase/domination і гарантований XP; далі `/api/chat` лише описує сцену.
