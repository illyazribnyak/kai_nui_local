...
export const SEX_MOVES: SexMove[] = [
  ...
  // —— Інтимні акти
  {
    ...
    label: 'Брудні слова',
    icon: '🗣️',
    description: 'Говорити брудно, стогнати, командувати словами',
    phase: 'any',
    staminaCost: { slow: 2, medium: 3, fast: 4 },
    pleasure: { lara: 6, partner: 10 },
    xp: 14,
  ...
  },
  {
    ...
    label: 'Дрочка руками',
    icon: '✋',
    description: 'Ручна стимуляція партнера',
    phase: 'any',
    staminaCost: { slow: 6, medium: 9, fast: 12 },
  ...
  },
  {
    ...
    label: 'Мінет',
    icon: '💋',
    description: 'Оральні ласки (потрібен Lv≥1)',
    phase: 'any',
    staminaCost: { slow: 8, medium: 11, fast: 15 },
    pleasure: { lara: 8, partner: 22 },
    xp: 18,
    playerPrompt: 'Лара бере в рот, смокче глибоко й волого — язик, губи, ритм під стогін партнера.',
    category: 'acts',
  },
  {
    id: 'act_deep',
    ...
    label: 'Глибоке горло',
    icon: '🌊',
    description: 'Deepthroat (потрібен Мінет у дереві + Lv≥1)',
    phase: 'main',
    staminaCost: { slow: 12, medium: 16, fast: 22 },
    pleasure: { lara: 10, partner: 28 },
    xp: 22,
    playerPrompt: 'Лара приймає глибоко в горло, стримує блювотний рефлекс, дивиться вгору мокрими очима.',
    category: 'acts',
  },
  {
    id: 'act_anal',
    ...
    label: 'Анал',
    icon: '🍑',
    description: 'Анальна близькість (Lv≥1, фаза main+)',
    phase: 'main',
    staminaCost: { slow: 10, medium: 14, fast: 18 },
    pleasure: { lara: 14, partner: 20 },
    xp: 20,
    playerPrompt: 'Лара готує й віддає анал — повільно, з контролем, потім глибше в обраному темпі.',
    category: 'acts',
  },
]
