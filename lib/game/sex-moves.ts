...
export const SEX_MOVES: SexMove[] = [
  ...
  // —— Анал (гілка)
  {
    ...
    icon: '🧴',
    description: 'Підготовка — без неї жорсткий анал дорожчий',
    phase: 'foreplay',
    staminaCost: { slow: 5, medium: 7, fast: 9 },
    pleasure: { lara: 8, partner: 8 },
    xp: 12,
    playerPrompt: 'Лара готує себе/його до аналу — пальці, змазка, дихання, розслаблення.',
    category: 'anal',
  },
  {
    id: 'an_main',
    ...
    label: 'Анал',
    icon: '🍑',
    description: 'Lv = глибина/інтенсивність аналу',
    phase: 'main',
    staminaCost: { slow: 10, medium: 14, fast: 18 },
    pleasure: { lara: 14, partner: 20 },
    xp: 20,
    playerPrompt: 'Лара бере анал на своєму рівні майстерності — від обережного входу до глибокого темпу.',
    category: 'anal',
  },
  {
    id: 'an_deep',
    ...
    label: 'Глибокий анал',
    icon: '🔻',
    description: 'Інтенсивніше (Lv≥1)',
    phase: 'main',
    staminaCost: { slow: 12, medium: 16, fast: 22 },
    pleasure: { lara: 16, partner: 24 },
    xp: 22,
    playerPrompt: 'Лара вимагає глибше й жорсткіше в анал — стегна, ритм, контроль.',
    category: 'anal',
  },
