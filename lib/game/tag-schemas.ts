...
export const StatUpdateSchema = z
  .object({
    ...
    attractiveness: num(1, 20).optional(),
    intellect: num(1, 20).optional(),
    libido: num(1, 20).optional(),
    bodySensitivity: num(1, 20).optional(),
    bodyProfileJson: z.union([z.string().max(8000), z.record(z.any())]).optional(),
