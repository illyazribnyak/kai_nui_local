...
export const CLOTHING_PRESETS: OutfitPreset[] = [
  ...
  {
    id: 'lace_panties',
    label: 'Мереживні еротичні трусики',
    description: 'Тонкі напівпрозорі мереживні трусики, що звабливо підкреслюють стегна.',
    icon: '🩲',
    category: 'clothing',
    lookKey: 'seductive',
    avatarImage: '/avatars/lara_seductive.png',
    badgeText: 'Еротична білизна',
    statBonusText: '+20 Бажання · +3 Харизма',
  },
  {
    id: 'silk_string_set',
    label: 'Шовковий бікіні-комплект (Стрінги)',
    description: 'Червоний шовковий комплект з тонкими зав\'язками та мінімальним покриттям.',
    icon: '👙',
    category: 'clothing',
    lookKey: 'seductive',
    avatarImage: '/avatars/lara_seductive.png',
    badgeText: 'Бікіні & Стрінги',
    statBonusText: '+25 Бажання · +4 Спокуса',
  },
  {
    id: 'transparent_vines',
    label: 'Прозоре плетіння з ліан',
    description: 'Викликальне островитянське плетіння з квітів та ліан, яке майже нічого не приховує.',
    icon: '🌿',
    category: 'clothing',
    lookKey: 'intimate',
    avatarImage: '/avatars/lara_intimate.png',
    badgeText: 'Екзотика',
    statBonusText: '+30 Бажання · Зменшення сорому',
  },
  {
    id: 'leather_corset',
    label: 'Звабливий шкіряний корсет',
    description: 'Підтягнутий шкіряний корсет зі шнурівкою, що підкреслює талію та груди.',
    icon: '💃',
    category: 'clothing',
    lookKey: 'confident',
    avatarImage: '/avatars/lara_confident.png',
    badgeText: 'Домінування',
    statBonusText: '+2 Сила · +3 Домінування',
  },
  {
    id: 'sports_bra_shorts',
    label: 'Спортивний топ та шортики',
    ...
    avatarImage: '/avatars/lara_confident.png',
    badgeText: 'Спорт',
    statBonusText: '+2 Спритність · +1 Витривалість',
  },
  {
    id: 'intimate',
