  ...
  },
  {
    ...
    completeWhen: {
      ...
      factKeys: [
        ...
        'spoke_with_naya',
        'naya_first_prophecy',
        'amulet_first_overcharge',
        'naya_sacred_elixir',
        'naya_ancestor_spirit',
      ],
    },
  },
  {
    ...
    completeWhen: {
      ...
      factKeys: [
        ...
        'met_arahu',
        'other_tribe_contact',
        'xeron_challenge_race',
        'gor_ak_harem_escape',
        'kira_matriarch_duel',
        'sow_matron_secret_deal',
        'arahu_first_manifestation',
      ],
    },
  },
  {
    ...
    completeWhen: {
      ...
      factKeys: [
        'found_temple',
        'temple_opened',
        'atlantean_portal_activated',
        'temple_chamber_of_ecstasy',
      ],
    },
  },
  {
