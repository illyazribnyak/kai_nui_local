...
export const CANON_NPC_PROFILES: NpcProfileSeed[] = [
  ...
  },
  {
    ...
    tribe: 'Гієноїди',
    notes:
      'Матріарх гієноїдів. Розумна й жорстока; гарем як влада. Колишній «жеребць»/розплідник — Зек, якого вона помітила death-scent. Арка: вимагає Зека → торг (Лара↔Зек) → суд/дуель → hyena_pact або війна.',
    personality: 'маніпулятивна, домінантна, розумна, жорстока, харизматична, територіальна',
    archetype: 'ватажок',
    attitude: 'curious',
    trust: 15,
    fear: 5,
  ...
  },
  {
    ...
    tribe: 'Гієноїди',
    notes:
      'ВТІКАЧ/ВІДСТУПНИК: сам вийшов зі стаї Кіри. Був «улюбленим жеребцем», зірвав ритуал повного підкорення, втік у ніч рейду. Death-scent — стая мусить повернути або вбити. Знає обхідні стежки й слабкі місця патрулів. Арка: сліди → зустріч → притулок/ціна тіла → таємниця → мисливці → маска запаху → зняти мітку → провідник → ультиматум Кіри → суд → клятва → доля (exile/companion/returned/dead).',
    personality:
      'полохливий, вдячний, хитрий, відданий захиснику, знервований, сексуально досвідчений, жадібний до свободи, ревнивий',
    archetype: 'вигнанець',
    attitude: 'fearful',
    trust: 40,
    fear: 60,
