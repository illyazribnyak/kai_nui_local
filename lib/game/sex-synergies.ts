...
export const SEX_SYNERGIES: SkillSynergy[] = [
  ...
  },
  {
    ...
    name: 'Брудні руки',
    icon: '🗣️✋',
    description: 'Гілка брудних слів + дрочка',
    condition: 'гілка dirty_talk ≥3 і handjob ≥3 (суми рівнів)',
    active: (s) => categoryLevels(s, 'dirty_talk') >= 3 && categoryLevels(s, 'handjob') >= 3,
  ...
  },
  {
    ...
    name: 'Горло майстра',
    icon: '💋🌊',
    description: 'Мінет + глибоке горло разом',
    condition: 'blowjob ≥3 і deepthroat ≥3',
    active: (s) => categoryLevels(s, 'blowjob') >= 3 && categoryLevels(s, 'deepthroat') >= 3,
  ...
  },
  {
    ...
    name: 'Брудний анал',
    icon: '🗣️🍑',
    description: 'Вербалка + анал',
    condition: 'dirty_talk ≥2 і anal ≥3',
    active: (s) => categoryLevels(s, 'dirty_talk') >= 2 && categoryLevels(s, 'anal') >= 3,
    effects: { partnerPleasureBonusPct: 12, laraPleasureBonusPct: 10, dominationFloorBonus: 5 },
  },
  {
    id: 'rider_queen',
    name: 'Королева сідла',
    icon: '🏇👑',
    description: 'Вершниця + домінування',
    condition: 'riding ≥3 і domination ≥2',
    active: (s) => categoryLevels(s, 'riding') >= 3 && categoryLevels(s, 'domination') >= 2,
    effects: { laraPleasureBonusPct: 12, dominationFloorBonus: 15 },
  },
  {
    id: 'edge_lord',
    name: 'Володар краю',
    icon: '⏸️⛓️',
    description: 'Еджинг + контроль',
    condition: 'edging ≥3 і (domination ≥2 або dirty_talk ≥2)',
    active: (s) =>
      categoryLevels(s, 'edging') >= 3 &&
      (categoryLevels(s, 'domination') >= 2 || categoryLevels(s, 'dirty_talk') >= 2),
    effects: { partnerPleasureBonusPct: 8, dominationFloorBonus: 12 },
  },
]
