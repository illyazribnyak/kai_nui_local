/**
 * System prompt builder for the chat GM.
...
import { MAX_WORLD_FACTS_IN_PROMPT, SKILL_NAMES } from '@/lib/game/constants'
...
import { formatRaceSexStatsForPrompt } from '@/lib/game/race-sex-stats'
...
import { formatActiveSkillEffectsForPrompt } from '@/lib/game/skill-effects'
