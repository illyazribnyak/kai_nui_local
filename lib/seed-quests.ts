...
const STARTER_FACTS = [
  ...
  },
  {
    ...
    category: 'world',
    content:
      'Канон: Тане і Лея — рідний брат і сестра з уже активним таємним інцестуальним інтимом; також Лея–Джек; Макаї, Найя, Араху; кентаври Ксерон/Іпполіта; мінотаври Гор-Ак/Міра; гієноїди Кіра/Зек; свинолюди Грух/Свиноматка.',
    dayNumber: 1,
  },
  {
  ...
  },
  {
    ...
    category: 'world',
    content:
      'Чутки: зі стаї Кіри втік самець-відступник (Зек). На ньому «запах смерті». Він може просити захисту в обмін на стежки й секрети матріархату.',
    dayNumber: 1,
  },
  {
    key: 'amulet_dormant',
